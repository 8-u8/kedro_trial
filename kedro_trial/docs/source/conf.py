...
# dex_pipeline_kedro documentation build
...
from dex_pipeline_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "dex_pipeline_kedro"
copyright = "2018-2019, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "dex_pipeline_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "dex_pipeline_kedro.tex",
        "dex_pipeline_kedro Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "dex_pipeline_kedro",
        "Project dex_pipeline_kedro codebase.",
        "Data-Science",
    )
]
